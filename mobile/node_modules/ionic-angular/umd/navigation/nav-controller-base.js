...
(function (factory) {
    ...
    var NavControllerBase = (function (_super) {
        ...
        NavControllerBase.prototype.push = function (page, params, opts, done) {
            var _this = this;
            return nav_util_1.convertToView(this._linker, page, params).then(function (viewController) {
        ...
        NavControllerBase.prototype.insertPages = function (insertIndex, insertPages, opts, done) {
            var _this = this;
            return nav_util_1.convertToViews(this._linker, insertPages).then(function (viewControllers) {
                return _this._queueTrns({
                    insertStart: insertIndex,
        ...
        NavControllerBase.prototype.setRoot = function (pageOrViewCtrl, params, opts, done) {
            var _this = this;
            return nav_util_1.convertToView(this._linker, pageOrViewCtrl, params).then(function (viewController) {
        ...
        NavControllerBase.prototype.setPages = function (pages, opts, done) {
            var _this = this;
            return nav_util_1.convertToViews(this._linker, pages).then(function (viewControllers) {
        ...
        NavControllerBase.prototype._queueTrns = function (ti, done) {
            ...
            ti.reject = function (rejectReason, transition) {
                ...
                while (transition) {
                    ...
                    if (enteringView && (enteringView._state === nav_util_1.STATE_ATTACHED)) {
        ...
        NavControllerBase.prototype._nextTrns = function () {
            ...
            if (insertViews) {
                for (var /** @type {?} */ i = 0; i < insertViews.length; i++) {
                    ...
                    if (nav && nav !== this || insertViews[i]._state === nav_util_1.STATE_DESTROYED) {
