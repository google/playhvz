...
Bridge.generateGroupId = () => Utils.generateId("group");
...
const SERVER_GROUP_PROPERTIES = ["allegianceFilter", "membersCanAdd", "autoAdd", "autoRemove"];
const SERVER_CHAT_ROOM_PROPERTIES = ["name"];
