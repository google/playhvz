...
let MAPPINGS = [
  ...
  {pattern: ["games", null, "players", null, "memberships"], newMap: "membershipsByChatRoomId", keyBy: "id"},
  ...
  {pattern: ["games", null, "chatRooms", null, "memberships"], newMap: "membershipsByPlayerId", keyBy: "id"},
